def build_config(dataset):
    ...
    if dataset == 'TinyVirat':
        cfg.data_folder = 'TinyVIRAT-v2/videos'
        cfg.train_annotations = 'TinyVIRAT-v2/tiny_train_v2.json'
        cfg.val_annotations = 'TinyVIRAT-v2/tiny_val_v2.json'
        cfg.test_annotations = 'TinyVIRAT-v2/tiny_test_v2_public.json'
        cfg.class_map = 'TinyVIRAT-v2/class_map.json'
        cfg.flow_folder = 'TinyVIRAT-v2/optical_flow'
        cfg.num_classes = 26
